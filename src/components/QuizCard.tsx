...
export function QuizCard({
  ...
  return (
    <section className="card">
      ...
      {speechAvailable && !speechReady && <p className="note">音声を初期化中です。再生ボタンをタップしてください。</p>}
      {speechError && <p className="note warning">{speechError}</p>}
      {debugVoiceLabel && <p className="debug-label">Voice: {debugVoiceLabel}</p>}
